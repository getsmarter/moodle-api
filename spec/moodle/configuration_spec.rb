...
module Moodle
  RSpec.describe Configuration do
    ...
    it '#web_service_api_url' do
      expect(configuration.web_service_api_url).to eq('http://example.com/webservice/rest/server.php')
    end

    it '#token_api_url' do
      expect(configuration.token_api_url).to eq('http://example.com/login/token.php')
    end
