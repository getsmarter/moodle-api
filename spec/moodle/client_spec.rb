  ...
  RSpec.describe Client do
    ...
    describe 'configuration setup' do
      it 'allows configuration via options' do
        client = Moodle::Client.new({host: 'host', token: 'token'})
    ...
    context 'valid configuration' do
      let(:client) { Moodle::Client.new(host: 'http://dev.vle.getsmarter.co.za', token: '072556801bf07076fff6bff2a463b7c5') }
    ...
    context 'invalid configuration' do
      let(:client) { Moodle::Client.new(host: 'http://dev.vle.getsmarter.co.za', token: 'invalidtoken') }
