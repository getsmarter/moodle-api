...
module Moodle::Api
  RSpec.describe Client do
    ...
    context 'valid configuration' do
      let(:client) { Moodle::Api::Client.new(host: 'http://my_moodle_instance.com', token: '072556801bf07076fff6bff2a463b7c5') }
    ...
    context 'invalid configuration' do
      let(:client) { Moodle::Api::Client.new(host: 'http://my_moodle_instance.com', token: 'invalidtoken') }
